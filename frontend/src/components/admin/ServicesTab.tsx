  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="glass-card-premium p-6 sm:p-12 text-center"><p className="text-slate-400">{t("admin.noServices")}</p></div>
      ) : (
        <div className="glass-card-premium overflow-hidden">
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody>
                {filtered.length === 0 ? (
                  <tr><td colSpan={7} className="p-6 sm:p-12 text-center text-slate-500">No results for &apos;{searchQuery}&apos;</td></tr>
                ) : (
                  filtered.map((s: any) => (
