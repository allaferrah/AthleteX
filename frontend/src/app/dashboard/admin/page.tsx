  ...
  return (
    <>
      ...
      <div className="dashboard-grid grid-cols-1 lg:grid-cols-[260px_1fr]">
        ...
        <main className="dashboard-main p-5 lg:p-8 xl:p-10">
          <div className="dashboard-header mb-4 lg:mb-8 pb-4 lg:pb-6">
          ...
          <div className="search-bar w-full max-w-xs sm:max-w-sm mb-4 mx-auto">
